...
def parse_args(input_args=None):
    ...
    parser.add_argument("--pretrained_subject_condition_lora_dir", type=str, default="/home/user01/aiotlab/hachi/code/UniCombine_Ins_Rm/output/train_condition_result/26_04_20-16:38/ckpt/checkpoint-20000")
